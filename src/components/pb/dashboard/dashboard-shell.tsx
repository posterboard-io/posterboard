    ...
    <div className="flex flex-col">
      <aside className="sticky top-0 h-screen w-56 bg-gray-100 dark:bg-slate-900 text-gray-800 p-4">        
        <nav className="space-y-2">
          <Button onClick={() => setActiveLink('/dashboard')} className={`w-full flex items-center space-x-2 bg-inherit hover:bg-gray-500 active:bg-gray-300 py-2 px-2 rounded-lg ${activeLink === '/dashboard' ? 'text-black' : 'text-gray-500'}`}>
            <Link href="/dashboard">
          ...
          <Button onClick={() => setActiveLink('/dashboard/recommended')} className={`w-full flex items-center space-x-2 bg-inherit hover:bg-gray-500 active:bg-gray-300 py-2 px-2 rounded-lg ${activeLink === '/dashboard/recommended' ? 'text-black' : 'text-gray-500'}`}>
          ...
          <Button onClick={() => setActiveLink('/dashboard/applications')} className={`w-full flex items-center space-x-2 bg-inherit hover:bg-gray-500 active:bg-gray-300 py-2 px-2 rounded-lg ${activeLink === '/dashboard/applications' ? 'text-black' : 'text-gray-500'}`}>
          ...
          <Button onClick={() => setActiveLink('/dashboard/resume')} className={`w-full flex items-center space-x-2 bg-inherit hover:bg-gray-500 active:bg-gray-300 py-2 px-2 rounded-lg ${activeLink === '/dashboard/resume' ? 'text-black' : 'text-gray-500'}`}>
